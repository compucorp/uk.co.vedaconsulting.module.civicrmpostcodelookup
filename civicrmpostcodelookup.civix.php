...
/**
 * @return CRM_Civicrmpostcodelookup_Upgrader
 */
function _civicrmpostcodelookup_civix_upgrader() {
  if (!file_exists(__DIR__ . '/CRM/Civicrmpostcodelookup/Upgrader.php')) {
    return NULL;
  }
  else {
    return CRM_Civicrmpostcodelookup_Upgrader_Base::instance();
  }
}
...
function _civicrmpostcodelookup_civix_civicrm_caseTypes(&$caseTypes) {
  ...
  foreach (_civicrmpostcodelookup_civix_glob(__DIR__ . '/xml/case/*.xml') as $file) {
...
function _civicrmpostcodelookup_civix_civicrm_angularModules(&$angularModules) {
  ...
  $files = _civicrmpostcodelookup_civix_glob(__DIR__ . '/ang/*.ang.php');
 ...
 * missing them.
 */
function _civicrmpostcodelookup_civix_fixNavigationMenu(&$nodes) {
  $maxNavID = 1;
  ...
  _civicrmpostcodelookup_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _civicrmpostcodelookup_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
  ...
  foreach ($origKeys as $origKey) {
    ...
    if (isset($nodes[$origKey]['child']) && is_array($nodes[$origKey]['child'])) {
      _civicrmpostcodelookup_civix_fixNavigationMenuItems($nodes[$origKey]['child'], $maxNavID, $nodes[$origKey]['attributes']['navID']);
    }
  }
}
